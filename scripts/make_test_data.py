            ...
            main_rows.append(
                {
                    **common,
                    ...
                    "ADMIN_PHONE_NUM": f"800{index:07d}",
                    "ADMIN_EIN": ein,
            ...
            sf_rows.append(
                {
                    **common,
                    ...
                    "SF_ADMIN_PHONE_NUM": f"866{index:07d}",
                    "SF_ADMIN_EIN": ein,
                    ...
                    "SF_FDCRY_TRUSTE_CUST_PHONE_NUM": f"877{index:07d}",
            ...
            sch_i.append(
                {
                    **common,
                    ...
                    "FDCRY_TRUSTEE_CUST_NAME": TRUSTEES[index % len(TRUSTEES)],
                    "FDCRY_TRUST_CUST_PHONE_NUM": f"888{index:07d}",
